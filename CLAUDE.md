...
Coding standards and design rules for the Company Currency Conversion API automation project.
...
API test framework for the customer API simulator (account, wallets, quotes/conversions).
Stack: **Python + pytest + requests**, pydantic v2 models, pytest-html report.
Live host: `https://[live-api-host]` (Swagger at `/docs`, spec at
`/openapi.json`).
